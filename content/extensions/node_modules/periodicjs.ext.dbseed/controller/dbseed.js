    ...
    if(!documents[x].datatype){
      ...
      if(documents[x].datatype==='userrole'){
        ...
        if(UserrolesObj.err){
          ...
          if(UserrolesObj.doc.privileges && UserrolesObj.doc.privileges.length>0){
            for(var z in UserrolesObj.doc.privileges){
              Userprivileges_userprivilegeid_array.push(UserrolesObj.doc.privileges[z]);
            }
          }
        }
      }
      ...
      if(documents[x].datatype==='user'){
        ...
        if(UsersObj.err){
          ...
          if(UsersObj.doc.usergroups && UsersObj.doc.usergroups.length>0){
            for(var q in UsersObj.doc.usergroups){
              Usergroups_usergroupid_array.push(UsersObj.doc.usergroups[q]);
            }
          }
        }
      }
