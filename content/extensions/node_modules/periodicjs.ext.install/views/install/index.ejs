...
<% include ../shared/nav %>
		...
		<div class="_pea-row">
			<div class="_pea-col-span10 _pea-col-nofloat">
				...
				<div class="_pea-document">
					<form action="/install/updateconfig" method="post" autocomplete="on" id="install_form" name="login_form" class="_pea-form _pea-ajaxforms" data-beforesubmitfunction="updateConsole">
						<input type="hidden" name="_csrf" value="<%= locals.token %>" >
						<div class="_pea-row _pea-container-forminput  no-margin">
							<h2 class="_pea-text-center">Configure your ECM Instance</h2>
							<div class="_pea-col-span12">
								...
								<div class="_pea-row _pea-container-forminput">
									...
									<input class="_pea-col-span9 noFormSubmit" type="text" placeholder="mongodb://localhost:27017/periodicjs_install" value="mongodb://localhost:27017/periodicjs_install" name="mongoconnectionurl"/>
								</div>
								<div class="_pea-row _pea-container-forminput">
										...
										<div class="_pea-col-span9 _pea-pull-right" style="padding-top: .5em; background: #fbfbfb;">
											<div id="admin-install-info">
												<div class="_pea-row _pea-container-forminput">
													...
													<input class="_pea-col-span6 noFormSubmit" type="text" placeholder="name@domain.com" value="<%= pagedata.temppassword %>@dm.com" name="email"/>
												</div>
												<div class="_pea-row _pea-container-forminput">
													<label class="_pea-col-span3 _pea-label _pea-text-right">Username </label>
													<input class="_pea-col-span6 noFormSubmit" type="text" placeholder="admin" value="<%= pagedata.temppassword %>" name="username"/>
												</div>
												<div class="_pea-row _pea-container-forminput">
												...
												<div class="_pea-row _pea-container-forminput">
													...
													<input class="_pea-col-span6 noFormSubmit" type="password" placeholder="" value="<%= pagedata.temppassword %>" name="passwordconfirm"/>
												</div>
											</div>
										</div>
									</div>
	...
	<div style="display:none;">
		...
		<div id="tt-mongodb" data-title="MongoDB Connection URI">
			<p>Periodicjs requires a mongodb database to store documents, for help installing locally check out <a href="http://docs.mongodb.org/manual/installation/">Installing MongoDB Locally</a> or use a free mongo hosting server like <a href="https://mongolab.com/">MongoLab</a></p>
