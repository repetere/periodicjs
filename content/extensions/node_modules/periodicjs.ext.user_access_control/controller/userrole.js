...
var update = function (req, res) {
    var updateuserrole = applicationController.removeEmptyObjectValues(req.body);

    updateuserrole.name = applicationController.makeNiceName(updateuserrole.title);
