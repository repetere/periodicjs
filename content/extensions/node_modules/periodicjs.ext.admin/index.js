...
module.exports = function(periodic){
	...
	var adminRouter = periodic.express.Router(),
		...
		itemController = require('../../../../app/controller/post')(periodic),
	...
	adminRouter.get('/posts',authController.ensureAuthenticated,itemController.loadItems,adminController.posts_index);
	...
	adminRouter.get('/post/edit/:id',authController.ensureAuthenticated,itemController.loadFullItem,adminController.post_edit);
	...
	// userRouter.post('/:id/delete',authController.ensureAuthenticated,mediaassetController.loadAsset,mediaassetController.remove);
	...
	periodic.app.use('/post',itemRouter);
