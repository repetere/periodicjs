...
module.exports = function (periodic) {
	 ...
	 */
	adminRouter.all('*', authController.ensureAuthenticated, adminController.loadUserRoles, adminController.check_user_access);
	extensionAdminRouter.all('*', authController.ensureAuthenticated, adminController.loadUserRoles, adminController.check_user_access);
	themeAdminRouter.all('*', authController.ensureAuthenticated, adminController.loadUserRoles, adminController.check_user_access);
	itemRouter.all('*', authController.ensureAuthenticated, adminController.loadUserRoles, adminController.check_user_access);
	collectionRouter.all('*', authController.ensureAuthenticated, adminController.loadUserRoles, adminController.check_user_access);
	tagRouter.all('*', authController.ensureAuthenticated, adminController.loadUserRoles, adminController.check_user_access);
	tagAdminRouter.all('*', authController.ensureAuthenticated, adminController.loadUserRoles, adminController.check_user_access);
	categoryRouter.all('*', authController.ensureAuthenticated, adminController.loadUserRoles, adminController.check_user_access);
	categoryAdminRouter.all('*', authController.ensureAuthenticated, adminController.loadUserRoles, adminController.check_user_access);
	contenttypeRouter.all('*', authController.ensureAuthenticated, adminController.loadUserRoles, adminController.check_user_access);
	contenttypeAdminRouter.all('*', authController.ensureAuthenticated, adminController.loadUserRoles, adminController.check_user_access);
	mediaRouter.all('*', authController.ensureAuthenticated, adminController.loadUserRoles, adminController.check_user_access);
	userAdminRouter.all('*', authController.ensureAuthenticated, adminController.loadUserRoles, adminController.check_user_access);
	 ...
	 * admin/user routes
	 */
	userAdminRouter.get('/edit-access', uacController.loadUserAccesControls, adminController.users_access);
	userAdminRouter.get('/edit-access/new', uacController.loadUserrole, adminController.users_access_role_new);
