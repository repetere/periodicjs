	...
	<div class="_pea-container">
		<div class="_pea_row">
			<div class="_pea-col-span12">
				<h1>Installed Themes <small><a href="#add-themes" class="">(Add Themes)</a></small></h1>
			</div>
		</div>
		<div class="_pea-row">
			<div class="_pea-col-span12">
									...
									themes.forEach(function(theme){ %>
										<tr id="tr-theme-<%= theme %>">
											<td class="_pea-col-span9"> 
												<a href="/p-admin/theme/<%= theme %>/"> <%= theme %>
												</a>
											</td>
		...
		<div class="_pea-row">
			<div class="_pea-col-span6">
				<h1><a name="add-themes"></a>Add Themes</h1>
			</div>
		</div>
		<div class="_pea-row">
			<div class="_pea-col-span12">
				<div class="_pea-document">
					<div class="_pea-row">
						...
						<div class="_pea-col-span2">
							<div class="_pea-row _pea-container-forminput _pea-text-center _pea-form">
								<input type="submit" name="upload-theme_button" value="Upload" class="_pea-button _pea-col-span12 _pea-color-default"/>
							</div>
						</div>
					</div>
		...
		<div id="theme-console" class="_pea-hidden">
			<div class="_pea_row">
				<div class="_pea-col-span12">
					<h1>Console Output <small><a id="hide-theme-console" class="">(hide)</a></small></h1>
				</div>
			</div>
			<div class="_pea_row">
