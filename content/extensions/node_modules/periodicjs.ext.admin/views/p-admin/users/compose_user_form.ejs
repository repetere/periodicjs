...
<div class="_pea-container">
	<div class="_pea-row">
		<div class="_pea-col-span10 _pea-col-nofloat">
			<% 
				var genericdoc = userprofile; 
				var genericdocTitle = userprofile.username; 
			%>
			
			<h2>
				<% if(genericdoc){%>Edit<%}else{%>New<%} %> User
				<%if(genericdoc){%>
				...
				<div class="_pea-row">
					<div class="_pea-row">
					  ...
					  <div class="_pea-col-span8">
							<div class="_pea-row _pea-container-forminput">
								...
								<input type="text" name="firstname" placeholder="first name" value="<%- userprofile.firstname %>" class="_pea-col-span6"/>
								<input type="text" name="lastname" placeholder="last name" value="<%- userprofile.lastname %>" class="_pea-col-span5 _pea-pull-right" style="margin-left:1em;"/>
							</div>
							<div class="_pea-row _pea-container-forminput">
								<small>Website</small>
								<input type="text" name="url" placeholder="http://mywebsite.com" value="<%- userprofile.url %>"  class="_pea-col-span12" />
							</div>
							<div class="_pea-row _pea-container-forminput">
								<small>Bio</small>
								<input type="text" name="description" placeholder="no profile"  class="_pea-col-span12" value="<%= userprofile.description %>"/>
							</div>
							<!-- <div class="_pea-row _pea-container-forminput">
						...
						<div class="_pea-col-span4  _pea-text-center" style="padding-left:1em;">
						<%
					...
					<div class="_pea-row _pea-form">
						<div class="_pea-col-span6">
							...
							<div class="_pea-row _pea-container-forminput">
								<small>Email</small>
								<input type="email" name="email" placeholder="Your email address" value="<%= userprofile.email %>" class="_pea-col-span12"/>
							</div>
							<div class="_pea-row _pea-container-forminput">
								<small>Username</small>
								<input type="text" name="username" placeholder="username"  value="<%= userprofile.username %>" class="_pea-col-span12" />
							</div>
							<div class="_pea-row _pea-container-forminput">
							...
							<div class="_pea-row _pea-container-forminput" style="margin-bottom:1.5em">
								...
								<input type="password" title="confirm your password" name="passwordconfirm" placeholder="confirm password" class="_pea-col-span12" />
							</div>
						</div>
						<div class="_pea-col-span6" style="padding-left:1em">
					...
					<div class="_pea-row _pea-container-forminput _pea-text-center no-margin">
						<input type="submit" name="save_button" value="<% if(genericdoc){%>Update<%}else{%>Save<%}%>" class="_pea-button _pea-color-info _pea-col-span2 _pea-col-nofloat"/>
					</div>
				</div>
			</div>
		</div>
