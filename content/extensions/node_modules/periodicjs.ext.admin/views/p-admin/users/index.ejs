	...
	<div class="_pea-container">
		<div class="_pea-row _pea-form">
			<div class="_pea-col-span6">
				<a href="/p-admin/users/new" class="_pea-button _pea-color-info">Create New Account</a>
				<a href="/p-admin/user/edit-access" class="_pea-button _pea-color-success">Manage User Access</a>
			</div>
							...
							<% if(users.length>0){
									users.forEach(function(user){ %>
										<tr>
											...
											<td>
													<a class="_pea-button _pea-text-small"><%= user.activated %></a>
											</td>
											<td>
													<a class="_pea-button _pea-text-small"><%= user.usertype %></a>
											</td>
											<td>
												<%if(user.userroles && user.userroles && user.userroles.length>0){
													user.userroles.forEach(function(userrole){%>
														<span class="_pea-button _pea-text-small"><%= userrole.title %></span>
													<%});
												}%>
											</td>
