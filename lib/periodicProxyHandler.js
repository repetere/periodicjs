...
function proxyHandler() {
  ...
  return {
    get: function (target, name) {
      ...
      } else if (name.includes('_utilities_')) { //_utilities_extensions_periodicjs.ext.dblogger
      ...
      } else if (name.includes('_controllers_')) { //_controllers_extensions_periodicjs.ext.dblogger
