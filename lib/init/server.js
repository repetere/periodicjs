...
function startHTTPserver() {
  return new Promise((resolve, reject) => {
    try {
      if (this.settings.application.server.http && this.settings.application.server.http.port && this.cluster.isMaster) {
...
function startHTTPSserver() {
  return new Promise((resolve, reject) => {
    try {
      if (this.settings.application.server.https && this.settings.application.server.https.port && this.cluster.isMaster) {
...
function startSocketIOserver() {
  return new Promise((resolve, reject) => {
    try {
      ...
      if (socker_server_config && socker_server_config.type && this.cluster.isMaster) {
