...
class periodic {
  ...
  constructor(options = {}) {
      ...
      this.initExtension = periodicExtension.init.initExtension.bind(this);
      this.installExtension = periodicExtension.install.installExtension.bind(this);
      this.uninstallExtension = periodicExtension.uninstall.uninstallExtension.bind(this);
      this.crud = {
        config: {
