...
function getFilePath(options) {
  ...
  switch (type) {
    ...
    case 'extension-local':
      return {
        configFilePath: `content/config/extensions/${name}/${environment}.json`,
        configDefaultSettings: require(path.resolve(this.app_root, `content/extensions/${name}/config/settings`)),
      };
    case 'con':
    case 'container':
      return {
    ...
    case 'container-local':
      return {
        configFilePath: `content/config/containers/${name}/${environment}.json`,
        configDefaultSettings: require(path.resolve(this.app_root, `content/container/${name}/config/settings`)),
      };
    default:
