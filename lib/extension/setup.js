...
/**
 * returns a Promise that sets the database and theme/extensions configurations on the instance of Periodic in the order of default settings, environment configurations, and override settings.
 * 
 * @param {Object} options 
 * @returns {Promise}
 */
...
/**
 * returns a Promise that sets the resources for the container/extension, i.e. router, controller,container/extension utilities, CLI commands, and transforms, on the instance of Periodic.
 * 
 * @param {Object} options 
 * @returns {Promise}
 */
