...
var periodic = function (periodicConfigOptions) {
	...
	var initializeApp = function(options,callback){
		...
		Promisie.promisify(initialize.loadConfiguration)(periodic_configure_obj)
			...
			.then((expresssettings_return_object)=>Promisie.promisify(initialize.customExpressSettings)(expresssettings_return_object))
			.then((customexpresssettings_return_object)=>Promisie.promisify(initialize.staticCaching)(customexpresssettings_return_object))
