		...
		switch(appThemeEnvSettings.homepage){
			...
			case 'compilation':
				...
				CoreController.loadModel({
					...
					population: population,
					callback: function (err, doc) {
						compliationController.loadCompilationData(req, res, err, doc, next, null);
					}
				});
				break;
			default:
...
var controller = function (resources) {
	...
	itemController = resources.app.controller.native.item;
	collectionController = resources.app.controller.native.collection;
	compliationController = resources.app.controller.native.compliation;
